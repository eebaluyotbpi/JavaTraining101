...
//
		...
		static void m6act4Solution (EntityManager em) {
				em.getTransaction().begin();

				Student student = new Student(); // transient
				student.setName("Dino");
				student.setAge(21);
				student.setEmail("Dino@onmicrosoft.com");

				em.flush(); // flush
				em.detach(student); // detach the student

				System.out.println("is newStudent inside the persistnce context :" + em.contains(student));

				student.setEmail("philipe@gmail.com");
				student.setAge(23);
